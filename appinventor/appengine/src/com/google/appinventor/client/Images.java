 ...
 *
 * Note: Images extends Tree.Resources rather than ClientBundle so that the
 * Images can be used with the com.google.gwt.user.client.ui.Tree class.
 *
 */
public interface Images extends Resources {
	...
	/**
	 * App Inventor Logo {@link Ode#createWelcomeDialog(boolean)}
	 */
	...
	/**
	 * Designer palette item: image component Also used for image file icon for
	 * project explorer
	 */
