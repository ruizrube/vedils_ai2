...
public final class Compiler {
  ...
  // IRR
 private static final String ARSCENE_ACTIVITY_CLASS =
     "com.google.appinventor.components.runtime.ar4ai.vuforia.VuforiaARActivity";
 ...
 private static final String ARSCENE_JPCT_SHADERS ="jpct_shaders.zip";
  ...
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded) {
    ...
    try {
      ...
      out.write("  <uses-sdk android:minSdkVersion=\"8\" android:targetSdkVersion=\"22\" />\n");

     // IRR out.write("  <uses-sdk android:minSdkVersion=\"3\" />\n");

      // IRR   out.write("  <uses-feature android:glEsVersion=\"0x00020000\" android:required=\"true\" />");
