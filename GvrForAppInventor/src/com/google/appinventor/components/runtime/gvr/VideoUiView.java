...
import com.google.appinventor.components.runtime.gvr.rendering.CanvasQuad;
...
public class VideoUiView extends LinearLayout {
  ...
  public static VideoUiView createForOpenGl(Context context, ViewGroup parent, CanvasQuad quad) {
    ...
    //edson Context theme = new ContextThemeWrapper(context, R.style.VrTheme);
	Context theme = new ContextThemeWrapper(context, R.style.AppBaseTheme);
	//edson VideoUiView view = (VideoUiView) View.inflate(theme, R.layout.activity_mai, null);
    VideoUiView view = (VideoUiView) View.inflate(theme, R.layout.activity_main, null);
    view.canvasQuad = quad;
    view.setLayoutParams(CanvasQuad.getLayoutParams());
    view.setVisibility(View.VISIBLE);
    parent.addView(view, 0);
    
    //edson view.findViewById(R.id.enter_exit_vr).setContentDescription(
    //edson		view.getResources().getString(R.string.exit_vr_label));
    view.findViewById(R.id.action_settings).setContentDescription(
        view.getResources().getString(R.string.action_settings));
  ...
  public void onFinishInflate() {
    ...
    //edson final ImageButton playPauseToggle = (ImageButton) findViewById(R.id.play_pause_toggle);
    final ImageButton playPauseToggle = (ImageButton) findViewById(R.id.action_settings);
        ...
        new OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            if (mediaPlayer.isPlaying()) {
              mediaPlayer.pause();
              //edson playPauseToggle.setBackgroundResource(R.drawable.play_button);
            //edson playPauseToggle.setContentDescription(getResources().getString(R.string.play_label));
            } else {
              mediaPlayer.start();
            //edson playPauseToggle.setBackgroundResource(R.drawable.pause_button);
            //edson playPauseToggle.setContentDescription(getResources().getString(R.string.pause_label));
            }
          }
        });
    //Edson 
    //edson seekBar = (SeekBar) findViewById(R.id.seek_bar);
    //seekBar = (SeekBar) findViewById(R.id.action_settings);
    //seekBar.setOnSeekBarChangeListener(new SeekBarListener());
    //edson statusText = (TextView) findViewById(R.id.status_text);
    //statusText = (TextView) findViewById(R.id.action_settings);
  }

  /** Sets the OnClickListener used to switch Activities. */
  @MainThread
  public void setVrIconClickListener(OnClickListener listener) {
	//edson ImageButton vrIcon = (ImageButton) findViewById(R.id.enter_exit_vr);
    ImageButton vrIcon = (ImageButton) findViewById(R.id.action_settings);
